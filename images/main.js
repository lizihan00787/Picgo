(function ($) {
	...
	class Silence {
		constructor() {
			this.defaluts = {
				...
				github: {
					...
					color: '#fff',
					fill: null,
					link: 'https://github.com/lizihan00787',
				},
				topImg: {
					homeTopImg: [
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/lizihan00787/articles/18323072">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/lizihan00787">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="https://www.cnblogs.com/lizihan00787/articles/18323061">关于</a><i></i></li>');
			//添加标签icon
			...
			let guanyu = '<ul class="sub-menu">' +
					'<li><a href="https://www.cnblogs.com/lizihan00787/articles/18323061 "><i class="fa fa-meetup" aria-hidden="true"></i> 我？</a></li>' +
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/lizihan00787/" alt="God_Max_Me">' +
					'<ruby><span class="sakuraso">God_Max_Me</span></span><span class="no">Origin</span><span class="shironeko">GMM</span>' +
					'<rt class="chinese-font">%%%</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
		...
		mainHeader() {
			...
			var header =
					...
					`       <h1 class="center-text glitch is-glitching Ubuntu-font" data-text="Hi, God_Max_Me!">${config.title}</h1>` +
		...
		for(let i = article_list.length-1;i>=0;i--)
		{
			...
			for(let j=PostTitles.length-1;j>=0;j--)
			{
				...
				if(url!=undefined)
				{
					...
					url = url = 'https://gcore.jsdelivr.net/gh/lizihan00787/Picgo/images/5.png';   
				}
